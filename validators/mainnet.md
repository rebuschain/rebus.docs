...
In order to streamline chain upgrades and minimise downtime, you may want to set up [cosmovisor](https://docs.cosmos.network/master/run-node/cosmovisor.html) to manage your node. A [guide for this is provided](setting-up-cosmovisor.md) in the Rebus docs.
...
Using only the raw metrics endpoint provided by `rebusd` you can get a working dashboard and alerting setup using Grafana Cloud. This means you don't have to run Grafana on the instance.
...
![A simple node dashboard example](../public/assets/screenshot-2021-10-05-at-09.29.48.png)
