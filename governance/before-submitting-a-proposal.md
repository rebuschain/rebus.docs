...
Once you have a clearly defined proposal idea. Fully draft your proposal text and submit to the Rebus commonwealth.im project page [here](https://commonwealth.im/rebus).
...
To get the most exposure for your conversation, advertise the link in the Telegram and Discord. Consider contacting the core devs to advertise the discussion on the official @RebusNetwork Twitter account.
...
Please note that the fee to fully fund a governance deposit is 500 REBUS. These funds will be returned to the depositor following completion of the voting period. If there are sufficient `NO WITH VETO` votes, the depositors will lose their funds. The depositor will also lose their funds if quorum of 33.4% is not reached.

## Closing thoughts

These are just guidelines to think about - obviously, Rebus is a community initiative, and what the community proposes and passes will be actioned. The core team does not always know what is best for the project.
